//
//  YBSignUpStudentListViewModel.m
//  HeiMao_B
//
...
@implementation YBSignUpStudentListViewModel
- (void)networkRequestRefresh{
    
    NSString *coachid = [UserInfoModel defaultUserInfo].userID;
    [NetWorkEntiry getCourseinfoWithUserId:coachid reservationstate:0 pageIndex:1 pageCount:10 success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        [self.systemMessageArray removeAllObjects];
        YBSignUpStuentListModelRootClass *informationMessageModel = [[YBSignUpStuentListModelRootClass alloc] initWithJsonDict:responseObject];
