...
#define SWBOOLToString(boolValue)     [NSString stringWithFormat:@"%d", boolValue]
#define SWIntToString(intValue)       [NSString stringWithFormat:@"%d", intValue]
#define SWLongToString(longValue)     [NSString stringWithFormat:@"%ld", longValue]
#define SWFloatToString(floatValue)   [NSString stringWithFormat:@"%f", floatValue]
#define SWDoubleToString(doubleValue) [NSString stringWithFormat:@"%lf", doubleValue]

#if __LP64__ || (TARGET_OS_EMBEDDED && !TARGET_OS_IPHONE) || TARGET_OS_WIN32 || NS_BUILD_32_LIKE_64
#define SWNSIntegerToString(longValue) [NSString stringWithFormat:@"%ld", longValue]
#else
#define SWNSIntegerToString(intValue) [NSString stringWithFormat:@"%d", intValue]
#endif

#if defined(__LP64__) && __LP64__
#define SWCGFloatToString(doubleValue) [NSString stringWithFormat:@"%lf", doubleValue]
#else
#define SWCGFloatToString(floatValue) [NSString stringWithFormat:@"%f", floatValue]
#endif
...
//用于 宽高比的转换
#define SWGetNewHeight(originCGSize, newWidth) (1.0f * newWidth * originCGSize.height / originCGSize.width)
